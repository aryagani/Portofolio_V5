...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/arya-gani-321135328?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@aryagni__",
    icon: Instagram,
    url: "https://www.instagram.com/aryagni__?igsh=MTZjaXRwemdwZHh2Yw==",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "@premiumhive",
    icon: Youtube,
    url: "https://www.youtube.com/@premiumhive",
    color: "#FF0000",
